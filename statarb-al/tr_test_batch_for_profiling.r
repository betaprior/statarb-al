...
### for profiling use smaller number of days:
## N <- 75
## source("functions.r")
## system.time(sig.f <- stock.etf.signals(ret.s,ret.e,tc.subset,num.days=N-est.win+1,compact.output=T,subtract.average=subtract.average))
